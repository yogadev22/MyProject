...
public:
	...
	struct FScriptDelegate                             ShadowColorAndOpacityDelegate;                            // 0x0258(0x0010) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      UnknownData02[0x12];                                      // 0x026E(0x0012) MISSED OFFSET
